...
export default function StartupHomeScreen() {
  const { candidates, fetchCandidates, likeCandidate, rejectCandidate, isLoading } = useStartupStore();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['left', 'right']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Swipe right to connect, left to pass</Text>
      </View>
